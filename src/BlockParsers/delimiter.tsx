...
const DelimiterBlock = ({
  item,
  config,
}: DelimiterProps): React.JSX.Element => {
  const currentConfig: DelimiterConfig = Object.assign(
    {},
    defaultDelimiterConfig,
    item,
  );
  return (
    <section key={item.id} className={currentConfig.classNames?.container}>
